...
const report: Report = {
  ...
  score: 77,
  verdict: 'fail',
  manualChecklist: [{ sc: '2.4.3', name: 'Focus Order', why: 'Order meaningfulness needs judgment.', how: 'Tab through and compare to reading order.', signal: null, automation: 'suspects' }],
