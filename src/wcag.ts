...
export const MANUAL_CHECKLIST: ManualCheckItem[] = [
  { sc: '1.2.2', name: 'Captions (Prerecorded)', why: 'Caption presence and accuracy for media needs human judgment.', signal: 'media', automation: 'suspects',
  ...
  { sc: '1.2.5', name: 'Audio Description (Prerecorded)', why: 'Whether visual information is conveyed in audio requires watching the content.', signal: 'media', automation: 'none',
  ...
  { sc: '1.3.3', name: 'Sensory Characteristics', why: 'Instructions relying on shape/position/sound ("click the round button on the right") need semantic review.', signal: null, automation: 'suspects',
  ...
  { sc: '1.4.1', name: 'Use of Color', why: 'Axe catches some cases; meaning conveyed only by color in charts, links, and states needs visual review.', signal: null, automation: 'evidence',
  ...
  { sc: '1.4.13', name: 'Content on Hover or Focus', why: 'Dismissable/hoverable/persistent behavior of tooltips and popovers must be interactively tested.', signal: 'hoverContent', automation: 'suspects',
  ...
  { sc: '2.1.2', name: 'No Keyboard Trap', why: 'The tab-walk check samples reachability; full trap detection needs interactive testing of every overlay.', signal: null, automation: 'suspects',
  ...
  { sc: '2.4.3', name: 'Focus Order', why: 'Automation checks reachability, not whether the order preserves meaning and operability.', signal: null, automation: 'suspects',
  ...
  { sc: '2.4.6', name: 'Headings and Labels', why: 'Whether headings/labels actually describe their content is a language judgment.', signal: null, automation: 'evidence',
  ...
  { sc: '2.5.7', name: 'Dragging Movements', why: 'Single-pointer alternatives to drag interactions must be exercised by hand.', signal: 'drag', automation: 'suspects',
  ...
  { sc: '2.5.8', name: 'Target Size (Minimum)', why: 'Axe flags some cases; overlapping targets and spacing exceptions need visual confirmation.', signal: null, automation: 'suspects',
  ...
  { sc: '3.1.2', name: 'Language of Parts', why: 'Foreign-language passages without lang attributes require content review.', signal: null, automation: 'suspects',
  ...
  { sc: '3.2.1', name: 'On Focus', why: 'Unexpected context changes on focus must be observed interactively.', signal: null, automation: 'checked',
  ...
  { sc: '3.2.2', name: 'On Input', why: 'Unexpected context changes when changing a setting must be observed interactively.', signal: 'forms', automation: 'evidence',
  ...
  { sc: '3.3.2', name: 'Labels or Instructions', why: 'Label presence is automatable; label adequacy is not.', signal: 'forms', automation: 'evidence',
  ...
  { sc: '3.3.3', name: 'Error Suggestion', why: 'Whether error messages actually tell users how to fix the problem is a content judgment.', signal: 'forms', automation: 'evidence',
  ...
  { sc: '3.3.7', name: 'Redundant Entry', why: 'Detecting re-requested information across a process requires understanding the flow.', signal: 'forms', automation: 'none',
